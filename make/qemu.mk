...
ifeq ($(NET_DEV), user)
  ifeq ($(HOSTFWD), y)
    qemu_user_netdev := -netdev user,id=net0,hostfwd=tcp::5555-:5555,hostfwd=udp::5555-:5555
  else
    qemu_user_netdev := -netdev user,id=net0
  endif
  qemu_args-$(NET) += $(qemu_user_netdev)
